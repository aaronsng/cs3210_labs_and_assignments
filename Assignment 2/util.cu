...
/**
 * [HOST] returns the value at the input row and col of the input grid, if valid.
 * 
 * -1 is returned if row or col is out of bounds (as specified by nRows and nCols).
 */
int getValueAtHost(const int *grid, int nRows, int nCols, int row, int col, int *val)
{
...
/**
 * [HOST] sets the value at the input row and col of the input grid to val.
 * 
